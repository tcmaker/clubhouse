...
def index(request):
    context = {
        'signups': SignupProgress.pending_approval.all(),
...
class ApproveHouseholdForm(LoginRequiredMixin, FormView):
    ...
    def get(self, request, *args, **kwargs):
        progress = SignupProgress.objects.get(pk=kwargs['pk'])
        self.initial = {
    ...
    def form_valid(self, form):
        ...
        activation.approve_household(SignupProgress.objects.get(pk=int(self.kwargs['pk'])))
